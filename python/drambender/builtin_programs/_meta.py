...
``drambender.builtin_programs.configure(...)``, which binds every meta-dependent
...
class _MetaBoundTemplate:
    ...
    def __call__(self, *args, **kwargs):
        raise TypeError(
            ...
            f"drambender.builtin_programs.configure(cachelines_per_row=..., "
...
def program_template(function):
    ...
    Equivalent to ``@drambender.api.program_template`` except: (a) tracing
