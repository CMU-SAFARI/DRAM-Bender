...
Both the row-mapping namespace (``drambender.rows``) and the pattern-mapping
namespaces (``drambender.patterns.bitline_mappings``,
``drambender.patterns.dq_mappings``) discover their built-ins by iterating a
