...
from draminspector.api.execution import TimingSummary
...
class DRAMCommandTrace:
    ...
    # draminspector.api.execution. Declared here so Pylance sees it.
...
class DDR4(Board):
    def __init__(self, instance_id: int = 0, host_interface: HostInterface = HostInterface.XDMA) -> None: ...
...
def open_board(board_type: BoardType, instance_id: int, host_interface: HostInterface = HostInterface.XDMA) -> Board: ...
