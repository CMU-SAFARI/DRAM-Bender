...
`draminspector.api.program.instructions` — import them there.
"""
...
from draminspector import _core
from draminspector._jit import (
    ScalarParamRef,
    ScalarSentinel,
...
if TYPE_CHECKING:
    from draminspector._core import FinalProgram
...
_PROGRAM_BUILDER_META: ContextVar[Any | None] = ContextVar(
    "draminspector_program_builder_meta",
    default=None,
)
...
class ProgramBuilder:
    ...
    ``draminspector.api.program.instructions`` for the command factories.
    """
    ...
    def LDPC(self, pc_type, rt):
        ...
        cyc) — see :class:`draminspector.api.PCType`. One fabric cycle.
        """
    ...
    def DRAM(self, op0, op1, op2, op3):
        ...
        ``draminspector.api.program.instructions`` (``PRE``, ``ACT``, ``RD``,
