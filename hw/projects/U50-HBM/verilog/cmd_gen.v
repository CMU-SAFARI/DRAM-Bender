...
module cmd_gen #(parameter CKE_WIDTH = 1, RANK_WIDTH = 1, DQ_WIDTH = 64, DRAM_CMD_SLOTS = 4,
    ...
    */
    ...
    assign fifo_data[137:72]    =  {    sid_r[0+:2],
                                        channel_id_r[0 +: 2*`HBM_CH_WIDTH],
                                        BA4_r[0 +: 2*`PC_WIDTH],
    ...
    assign fifo_data[65:0]      =  {    sid_r[2+:2],
                                        channel_id_r[2*`HBM_CH_WIDTH +: 2*`HBM_CH_WIDTH],
