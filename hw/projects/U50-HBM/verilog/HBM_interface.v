...
module HBM_interface # (
	...
	localparam CMD_ACT		= 3'b010;   // todo, 3rd bit is SID
	...
	// Other parameters
	localparam PAR		    = 1'b0; // Parity signal
		...
		begin
			...
			begin
			    ...
			    if (r_cmd_type_ps[0] == `ACTT) begin
			        // CC1
                    r_row_cmd[0]	    <= {r_ba_addr[`BA_ADDR_WIDTH*0 + 3], r_row_addr[`ROW_ADDR_WIDTH*0 + 13], r_BA4[0], PAR, r_row_addr[`ROW_ADDR_WIDTH*0+11 +: 2], r_ba_addr[`BA_ADDR_WIDTH*0 +: 3], r_sid[0], CMD_ACT[1:0]};
                    // CC2
			        ...
			        // CC1
			        r_row_cmd[0]	    <= {r_ba_addr[`BA_ADDR_WIDTH*1 + 3], r_row_addr[`ROW_ADDR_WIDTH*1 + 13], r_BA4[1], PAR, r_row_addr[`ROW_ADDR_WIDTH*1+11 +: 2], r_ba_addr[`BA_ADDR_WIDTH*1 +: 3], r_sid[1], CMD_ACT[1:0]};
			        // CC20
                    ...
                    for (i = 0; i < 2; i = i + 1) begin
                        case (r_cmd_type_ps[i])
                            ...
                            `PREE:
                            begin
                                r_row_cmd[i]		<= {r_ba_addr[`BA_ADDR_WIDTH*i + 3], 1'b0, r_BA4[i], PAR, r_sid[i], 1'b1, r_ba_addr[`BA_ADDR_WIDTH*i +: 3], CMD_PRE};
                            end
                            `PREA:
                            begin
                            ...
                            `REFSB:
                            begin
                                r_row_cmd[i]		<= {r_ba_addr[`BA_ADDR_WIDTH*i + 3], 1'b0, r_BA4[i], PAR, r_sid[i], 1'b1, r_ba_addr[`BA_ADDR_WIDTH*i +: 3], CMD_REFSB};
                            end
                            `REFF:
                            begin
                    ...
                    case (r_cmd_type_ps[i])
                        ...
                        begin
                            ...
                            // So here col_addr[4:0] corresponds to col_addr[5:1] in the JEDEC standard
                              r_col_cmd[i]		<= {r_BA4[i], r_col_addr[`COL_ADDR_WIDTH*i+1 +: 4], PAR, r_col_addr[`COL_ADDR_WIDTH*i], r_sid[i], r_ba_addr[`BA_ADDR_WIDTH*i +: 4], CMD_RD};
                        end
                        `RDA:
                        begin
                              r_col_cmd[i]		<= {r_BA4[i], r_col_addr[`COL_ADDR_WIDTH*i+1 +: 4], PAR, r_col_addr[`COL_ADDR_WIDTH*i], r_sid[i], r_ba_addr[`BA_ADDR_WIDTH*i +: 4], CMD_RDA};
                        end
                        `WR:
                        begin
                              r_col_cmd[i]		<= {r_BA4[i], r_col_addr[`COL_ADDR_WIDTH*i+1 +: 4], PAR, r_col_addr[`COL_ADDR_WIDTH*i], r_sid[i], r_ba_addr[`BA_ADDR_WIDTH*i +: 4], CMD_WR};
                        end
                        `WRA:
                        begin
                              r_col_cmd[i]		<= {r_BA4[i], r_col_addr[`COL_ADDR_WIDTH*i+1 +: 4], PAR, r_col_addr[`COL_ADDR_WIDTH*i], r_sid[i], r_ba_addr[`BA_ADDR_WIDTH*i +: 4], CMD_WRA};
                        end
