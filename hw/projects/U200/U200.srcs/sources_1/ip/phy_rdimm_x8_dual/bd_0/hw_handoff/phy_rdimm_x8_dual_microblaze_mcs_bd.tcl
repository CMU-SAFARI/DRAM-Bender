...
################################################################
# This is a generated script based on design: bd_afa8
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./U200.srcs/sources_1/ip/phy_rdimm_x8_dual/bd_0
