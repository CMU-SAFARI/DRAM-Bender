...
// Date        : Wed Aug  5 14:24:19 2026
// Host        : safari-fpga99 running 64-bit Ubuntu 24.04.4 LTS
// Command     : write_verilog -force -mode synth_stub -rename_top xdma_dual -prefix
//               xdma_dual_ xdma_dual_stub.v
// Design      : xdma_dual
...
(* X_CORE_INFO = "xdma_dual_core_top,Vivado 2020.2" *)
module xdma_dual(sys_clk, sys_clk_gt, sys_rst_n, user_lnk_up, 
  ...
  m_axis_h2c_tvalid_0, m_axis_h2c_tready_0, m_axis_h2c_tkeep_0, s_axis_c2h_tdata_1, 
  s_axis_c2h_tlast_1, s_axis_c2h_tvalid_1, s_axis_c2h_tready_1, s_axis_c2h_tkeep_1, 
  m_axis_h2c_tdata_1, m_axis_h2c_tlast_1, m_axis_h2c_tvalid_1, m_axis_h2c_tready_1, 
  m_axis_h2c_tkeep_1)
/* synthesis syn_black_box black_box_pad_pin="sys_clk,sys_clk_gt,sys_rst_n,user_lnk_up,pci_exp_txp[7:0],pci_exp_txn[7:0],pci_exp_rxp[7:0],pci_exp_rxn[7:0],axi_aclk,axi_aresetn,usr_irq_req[0:0],usr_irq_ack[0:0],msi_enable,msi_vector_width[2:0],cfg_mgmt_addr[18:0],cfg_mgmt_write,cfg_mgmt_write_data[31:0],cfg_mgmt_byte_enable[3:0],cfg_mgmt_read,cfg_mgmt_read_data[31:0],cfg_mgmt_read_write_done,s_axis_c2h_tdata_0[255:0],s_axis_c2h_tlast_0,s_axis_c2h_tvalid_0,s_axis_c2h_tready_0,s_axis_c2h_tkeep_0[31:0],m_axis_h2c_tdata_0[255:0],m_axis_h2c_tlast_0,m_axis_h2c_tvalid_0,m_axis_h2c_tready_0,m_axis_h2c_tkeep_0[31:0],s_axis_c2h_tdata_1[255:0],s_axis_c2h_tlast_1,s_axis_c2h_tvalid_1,s_axis_c2h_tready_1,s_axis_c2h_tkeep_1[31:0],m_axis_h2c_tdata_1[255:0],m_axis_h2c_tlast_1,m_axis_h2c_tvalid_1,m_axis_h2c_tready_1,m_axis_h2c_tkeep_1[31:0]" */;
  input sys_clk;
  input sys_clk_gt;
  input sys_rst_n;
  output user_lnk_up;
