...
################################################################
# This is a generated script based on design: bd_ba6a
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./U200.srcs/sources_1/ip/phy_ddr4_udimm/bd_0
