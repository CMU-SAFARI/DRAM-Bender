...
28'h0010021: begin //c0_ddr4_adr[17] IO_L10N_T1U_N7_QBC_AD4N_40
  riu_addr_cal = 6'hC;
  riu_nibble = 'h3;
end

28'h0010080: begin //c0_ddr4_ba[0] IO_L12P_T1U_N10_GC_40
  riu_addr_cal = 6'hF;
  riu_nibble = 'h3;
end

28'h0010081: begin //c0_ddr4_ba[1] IO_L12N_T1U_N11_GC_40
  riu_addr_cal = 6'h10;
  riu_nibble = 'h3;
end

28'h0010100: begin //c0_ddr4_bg[0] IO_T1U_N12_40
  riu_addr_cal = 6'h11;
  riu_nibble = 'h3;
end

28'h0010101: begin //c0_ddr4_bg[1] IO_L13P_T2L_N0_GC_QBC_40
  riu_addr_cal = 6'hB;
  riu_nibble = 'h4;
end

28'h0010400: begin //c0_ddr4_cs_n[0] IO_L13N_T2L_N1_GC_QBC_40
  riu_addr_cal = 6'hC;
  riu_nibble = 'h4;
end

28'h0010200: begin //c0_ddr4_cke[0] IO_L14P_T2L_N2_GC_40
  riu_addr_cal = 6'hD;
  riu_nibble = 'h4;
end

28'h0010800: begin //c0_ddr4_odt[0] IO_L14N_T2L_N3_GC_40
  riu_addr_cal = 6'hE;
  riu_nibble = 'h4;
end

28'h0010040: begin //c0_ddr4_act_n IO_L15P_T2L_N4_AD11P_40
  riu_addr_cal = 6'hF;
  riu_nibble = 'h4;
end

28'h0011000: begin //c0_ddr4_parity IO_L16P_T2U_N6_QBC_AD3P_40
  riu_addr_cal = 6'hB;
  riu_nibble = 'h5;
end
