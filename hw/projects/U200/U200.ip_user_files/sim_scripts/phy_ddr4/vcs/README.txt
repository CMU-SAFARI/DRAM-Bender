...
#
# Generated by export_simulation on Tue Jul 11 09:58:18 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './phy_ddr4.sh' script.

./phy_ddr4.sh -reset_run
...
./phy_ddr4.sh -noclean_files

For more information on the script, please type './phy_ddr4.sh -help'.
