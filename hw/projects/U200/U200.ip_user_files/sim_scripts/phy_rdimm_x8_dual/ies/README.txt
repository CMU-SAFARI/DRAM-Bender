...
#
# Generated by export_simulation on Tue Jul 11 09:59:42 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './phy_rdimm_x8_dual.sh' script.

./phy_rdimm_x8_dual.sh -reset_run
...
./phy_rdimm_x8_dual.sh -noclean_files

For more information on the script, please type './phy_rdimm_x8_dual.sh -help'.
