...
#
# Generated by export_simulation on Tue Jul 11 10:00:05 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './xdma.sh' script.
...
./xdma.sh -noclean_files

For more information on the script, please type './xdma.sh -help'.
