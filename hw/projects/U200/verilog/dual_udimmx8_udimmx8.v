module dual_udimmx8_udimmx8 (
  ...
  output [17-1:0]       c0_ddr4_adr,
  output [1:0]          c0_ddr4_ba,
  output [1:0]          c0_ddr4_bg,
  output [2-1:0]        c0_ddr4_cke,
  output [2-1:0]        c0_ddr4_odt,
  output [2-1:0]        c0_ddr4_cs_n,
  output [1-1:0]        c0_ddr4_ck_t,
  output [1-1:0]        c0_ddr4_ck_c,
  ...
  output [17-1:0]       c1_ddr4_adr,
  output [1:0]          c1_ddr4_ba,
  output [1:0]          c1_ddr4_bg,
  output [2-1:0]        c1_ddr4_cke,
  output [2-1:0]        c1_ddr4_odt,
  output [2-1:0]        c1_ddr4_cs_n,
  output [1-1:0]        c1_ddr4_ck_t,
  output [1-1:0]        c1_ddr4_ck_c,
  ...
  // AXI streaming ports
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH-1:0]   h2c_tdata_0,xdma_h2c_tdata_0;
  (*dont_touch = "yes"*) wire                              h2c_tlast_0, xdma_h2c_tlast_0;
  (*dont_touch = "yes"*) wire                              h2c_tvalid_0, xdma_h2c_tvalid_0;
  (*dont_touch = "yes"*) wire                              h2c_tready_0, xdma_h2c_tready_0;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH/8-1:0] h2c_tkeep_0, xdma_h2c_tkeep_0;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH-1:0]   c2h_tdata_0, xdma_c2h_tdata_0; 
  (*dont_touch = "yes"*) wire                              c2h_tlast_0, xdma_c2h_tlast_0;
  (*dont_touch = "yes"*) wire                              c2h_tvalid_0, xdma_c2h_tvalid_0;
  (*dont_touch = "yes"*) wire                              c2h_tready_0, xdma_c2h_tready_0;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH/8-1:0] c2h_tkeep_0, xdma_c2h_tkeep_0;

  // AXI streaming ports
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH-1:0]   h2c_tdata_1,xdma_h2c_tdata_1;
  (*dont_touch = "yes"*) wire                              h2c_tlast_1, xdma_h2c_tlast_1;
  (*dont_touch = "yes"*) wire                              h2c_tvalid_1, xdma_h2c_tvalid_1;
  (*dont_touch = "yes"*) wire                              h2c_tready_1, xdma_h2c_tready_1;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH/8-1:0] h2c_tkeep_1, xdma_h2c_tkeep_1;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH-1:0]   c2h_tdata_1, xdma_c2h_tdata_1; 
  (*dont_touch = "yes"*) wire                              c2h_tlast_1, xdma_c2h_tlast_1;
  (*dont_touch = "yes"*) wire                              c2h_tvalid_1, xdma_c2h_tvalid_1;
  (*dont_touch = "yes"*) wire                              c2h_tready_1, xdma_c2h_tready_1;
  (*dont_touch = "yes"*) wire [`XDMA_AXI_DATA_WIDTH/8-1:0] c2h_tkeep_1, xdma_c2h_tkeep_1;

  softmc_udimmx8_top smc1
  (
  // common signals
  ...
  wire          msi_enable;
  (*dont_touch = "yes"*) wire          user_lnk_up, usr_irq_req, usr_irq_ack;
